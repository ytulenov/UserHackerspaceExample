...
const Gallery: React.FC<GalleryProps> = ({ productValues }) => {
  // Collecting all images from all Productvalues
  const allImages = productValues.flatMap((productValue) => productValue.images);
